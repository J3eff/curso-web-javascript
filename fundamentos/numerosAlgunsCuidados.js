...
console.log("10" / 2) // Ele valida se é possivel fazer a conversão da string da para valor numerico e faz o caculo
console.log("Show!" * 2) // Retorna Not-A-Number (não é um número)
